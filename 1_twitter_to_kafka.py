...
def get_tweets():
    ...
    query_data = [('delimited', 'length'), ('language', 'en'), ('track','bitcoin,monero,ripple,ybcoin,dogecoin,dash,maidsafecoin,lisk,siacoin,cryptocurrency,crypto'), ('locations', '-169.7369071437,23.6595686079,-64.35549002,71.60482164')]
    # query_data = [('delimited', 'length'), ('language', 'en'), ('track','bitcoin,monero,ripple,ybcoin,dogecoin,dash,maidsafecoin,lisk,siacoin,cryptocurrency,crypto')]
